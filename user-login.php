...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Collect form data
    $farmer_name = $_POST['farmer_name']; // New field for farmer's name
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["photo"]["tmp_name"], $target_file)) {
            ...
            $sql = "INSERT INTO produce (farmer_name, category, name, variety, quantity, price, address, photo) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
            $stmt = $conn->prepare($sql);
            $stmt->bind_param("sssidsis", $farmer_name, $category, $name, $variety, $quantity, $price, $address, $target_file);
    ...
    <main>
        <section class="upload-form">
            ...
            <div class="produce-box">
                <img src="<?php echo $target_file; ?>" alt="Produce photo" width="100" height="100">
                <div class="produce-details">
                    <p><strong>Farmer Name:</strong> <?php echo htmlspecialchars($farmer_name); ?></p>
